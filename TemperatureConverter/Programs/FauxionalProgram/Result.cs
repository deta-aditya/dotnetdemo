...
public abstract class Result<TLeft, TRight>
{
    ...
    public abstract Result<TLeftNew, TRightNew> Bind<TLeftNew, TRightNew>(Func<TRight, Result<TLeftNew, TRightNew>> func);
    ...
    public static Func<Result<TLeft, T1>, Result<TLeft, T2>, Result<TLeft, T3>, Result<TLeft, TRight>> Lift3<T1, T2, T3>(
        Func<T1, T2, T3, TRight> func)
    {
        return (result1, result2, result3) => (result1, result2, result3) switch
        {
            (Ok<TLeft, T1> ok1, Ok<TLeft, T2> ok2, Ok<TLeft, T3> ok3) => new Ok<TLeft, TRight>(func(ok1.Value, ok2.Value, ok3.Value)),
    ...
    public static Func<Result<TLeft, T1>, Result<TLeft, T2>, Result<TLeft, T3>, Result<TLeft, T4>, Result<TLeft, TRight>> Lift4<T1, T2, T3, T4>(
        Func<T1, T2, T3, T4, TRight> func)
    {
        return (result1, result2, result3, result4) => (result1, result2, result3, result4) switch
        {
            (Ok<TLeft, T1> ok1, Ok<TLeft, T2> ok2, Ok<TLeft, T3> ok3, Ok<TLeft, T4> ok4) => new Ok<TLeft, TRight>(func(ok1.Value, ok2.Value, ok3.Value, ok4.Value)),
...
public class Ok<TLeft, TRight> : Result<TLeft, TRight>
{
    ...
    public override Result<TLeftNew, TRightNew> Bind<TLeftNew, TRightNew>(Func<TRight, Result<TLeftNew, TRightNew>> func)
    {
        return func(Value);
    }
